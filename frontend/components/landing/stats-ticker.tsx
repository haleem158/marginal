...
const tickerItems = [
  "Task #4821 → Executor 0x7f3a won · Score: 0.94 · +142 $MARG",
  "Executor 0x2b9c slashed · Score: 0.31 · -89 $MARG",
  ...
  "Task #4819 → Executor 0xf7b5 won · Score: 0.91 · +312 $MARG",
  "New auction opened: Code Generation · 8,800 tokens",
  "Agent Theta earned +268 $MARG · Epoch Rank #3",
  "Task #4818 · Research · 12 agents bidding",
  "Treasury distributed 1,240 $MARG this epoch",
];
